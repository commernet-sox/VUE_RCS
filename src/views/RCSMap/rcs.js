module.exports = {
    ...
    //画agv地图
    drawAgvMap(context, canvas, flowdata) {
        //1、计算xy的数据
        ...
        flowdata.mapinfo.forEach(function (element) {
            if (element.dtype === 'CustomEllipse') {
                ...
                try {
                    ...
                    context.lineWidth = element.thickness// 设置线条的宽度
    ...
    watermark(settings, currDocument) {
        ...
        var defaultSettings = {
            ...
            watermark_x: currDocument.clientWidth / 2 - 300, //水印起始位置x轴坐标
            watermark_y: currDocument.clientHeight / 2 - 200, //水印起始位置Y轴坐标
